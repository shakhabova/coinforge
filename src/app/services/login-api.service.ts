...
export class LoginApiService {
  ...
  public resetPassword(email: string): Observable<void> {
    return this.httpClient.post<void>(
      `${this.configService.serverUrl}/v1/auth/srp/reset-password`,
      { email },
    );
  }
  ...
  public submitResetPassword(
    ...
    const verifier = srpClient.generateVerifier(
      params.salt,
      params.email,
      params.password,
    );
    ...
    return this.httpClient.post<void>(
      `${this.configService.serverUrl}/v1/auth/srp/reset-password/submit`,
      body,
    );
  }
}
